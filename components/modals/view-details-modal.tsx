      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="grid gap-6 py-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <DetailField label="Employee Name" value={item.finderName} />
          </div>
            ...
            <div className="border-t pt-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <DetailField
                  ...
                  value={item.handoverBy || "N/A"}
                />
                <DetailField
                  label="Receiver Name"
                  value={item.handoverReceiverName || "N/A"}
                />
                <DetailField
                  label="Contact Number"
                  value={item.handoverContactNumber || "N/A"}
                />
              </div>
            </div>
          )}
            ...
            <div className="border-t pt-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <DetailField
                  label="Dispatch Date"
                  value={format(
                    new Date(item.dispatchDate),
                    "MMMM dd, yyyy HH:mm",
                  )}
                />
                <DetailField
                  label="Dispatched By"
                  value={item.dispatchBy || "N/A"}
                />
              </div>
            </div>
          )}
