...
export function AddItemModal({ open, onClose, onSuccess }: AddItemModalProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    locationFound: "Room" as ItemLocation | "",
    roomNumber: "",
    guestName: "",
    finderName: "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const dispatchDeadline = addDays(
        new Date(formData.dateFound),
        dispatchDays,
      );
      ...
      const newItem = {
        ...
        roomNumber:
          formData.locationFound === "Room" ? formData.roomNumber : undefined,
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Fill in the details below to register a new lost item.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <FieldGroup className="py-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Field>
                <FieldLabel htmlFor="locationFound">
                  Location Found *
                </FieldLabel>
                <Select
                  ...
                  onValueChange={(value) =>
                    setFormData({
                      ...formData,
                      locationFound: value as ItemLocation,
                    })
                  }
                  required
                >
